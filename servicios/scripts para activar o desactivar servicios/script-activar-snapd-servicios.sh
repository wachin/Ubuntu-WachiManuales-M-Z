...
sudo -u wachin systemctl enable snapd.autoimport.service
sudo -u wachin systemctl enable snapd.core-fixup.service
sudo -u wachin systemctl enable snapd.seeded.service 
sudo -u wachin systemctl enable snapd.service
sudo -u wachin systemctl enable snapd.system-shutdown.service 
